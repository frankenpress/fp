...
func newApplyCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long: `Stages the named snapshot directory into the running site container
and runs wp fp apply against it. Useful for round-trip iteration on
the local docker-compose stack: capture, edit, apply, repeat.
